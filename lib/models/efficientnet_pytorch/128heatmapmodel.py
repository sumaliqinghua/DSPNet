...
class EfficientNet(nn.Module):
    ...
    def __init__(self, cfg,blocks_args=None, global_params=None,**kwargs):#不会被前面两个参数干扰了吧
        ...
        self.channel_att2 = SEBlock(32,2)
        # self.channel_att3 = SEBlock(64,2)
        self.channel_att4 = SEBlock(32,2)
        self.channel_att5 = SEBlock(32,2)
    ...
    def forward(self, inputs):
        ...
        xd4 = self.deconv_layers4[2](xd4)#【y】+xd4吗
        ...
        xd5 = self.deconv_layers5[3](xd5)#【】加x1吗
