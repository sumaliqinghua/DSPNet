...
class EfficientNet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        xd3_first = self.deconv_layers3[0](x3)#这儿是x3不是x2；加x2吗？
        xd3 = self.deconv_layers3[1](xd3_first)#【y】+xd4吗
        xd4_first = self.deconv_layers4[0](x4)#
        xd4_second = self.deconv_layers4[1](xd4_first)  #因为d4刚经过了relu值会比较小
        xd4 = self.deconv_layers4[2](xd4_second)#【】加x1吗
