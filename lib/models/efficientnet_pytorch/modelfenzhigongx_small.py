...
class EfficientNet(nn.Module):
    ...
    def __init__(self, cfg,blocks_args=None, global_params=None,**kwargs):#不会被前面两个参数干扰了吧
        ...
        self. change_channel_2 = self._change_channel(extra.DECONV_INCHANNELS[0],64)
        self. change_channel_3 = self._change_channel(extra.DECONV_INCHANNELS[1],128)
        self. change_channel_4 = self._change_channel(extra.DECONV_INCHANNELS[2],128)
        ...
        self.final_layer = nn.Conv2d(
            in_channels=extra.STAGE5.NUM_DECONV_FILTERS[-1],  # 256
        ...
        self.channel_att2 = SEBlock(32,1)
        self.channel_att3 = SEBlock(32,1)
        self.channel_att4 = SEBlock(32,1)
        self.channel_att5 = SEBlock(32,1)
    ...
    def forward(self, inputs):
        ...
        x3 =self.change_channel_3(x3)#左
        x4 =self.change_channel_4(x4)#左
        xd2 = self.deconv_layers5[2](x2)  #【】+xd4吗还是xd3y;用xd3_first吗不用的话就x2
        xd2 = self.channel_att5(xd2)
        xd3 = self.deconv_layers5[1](x3)#这儿是x3不是x2；加x2吗？
        xd3 = self.deconv_layers5[2](xd3)#【y】+xd4吗
        xd3 = self.channel_att3(xd3)
        xd4 = self.deconv_layers5[1](x4)#这儿是x3不是x2；加x2吗？
        xd4 = self.deconv_layers5[2](xd4)#【y】+xd4吗
        xd4 = self.channel_att4(xd4)#suiran quanzhongyiyang dan tezhengtu buyiyang
