...
class SimpleSelfAttention(nn.Module):
    def __init__(self, n_in:int, ks=1, sym=False):#, n_out:int):
        ...
        self.midchannel = n_in
        self.conv = nn.Conv2d(n_in, self.midchannel, ks, padding=ks//2,groups=n_in, bias=False)
        self.conv1 = nn.Conv2d(n_in, 1, ks, padding=ks//2, bias=False)
        self.convexp = nn.Conv2d(self.midchannel, n_in, ks, padding=ks//2, bias=False,groups=n_in)
