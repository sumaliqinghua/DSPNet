...
class MultiResNet(nn.Module):
    ...
    def __init__(self, block, layers, cfg, **kwargs):  # **kwargs代表什么含义
        ...
        self.change_channel_2 =nn.Sequential(nn.Conv2d(
        ...
        self.change_channel_3 =nn.Sequential(nn.Conv2d(
        ...
        self.sse_x2 = SSEBlock(512)
        self.sse_x3 = SSEBlock(1024)
        self.sse_x4 = SSEBlock(2048)
    ...
    def forward(self, x):
        ...
        # x2 = self.sse_x2(x2)
        x3 = self.change_channel_3(x3)
        # x3 = self.sse_x3(x3)
        xd4 = self.deconv_layers4[0](x4)+x3
        xd4 = self.deconv_layers4[1](xd4)+x2  # x2还是xd3_first
